 ...
 * @author Grupo 5
 */
public class VentanaReporteMedico extends javax.swing.JInternalFrame {
   
    private ArrayList <Medico> datos= new ArrayList<>();
     ...
     */
    public VentanaReporteMedico(java.awt.Frame parent) {
        initComponents();
        ventana=parent;
    ...
    /**
     * carga los datos de los médicos y los guarda en un arreglo
     */
    private void cargarDatos()
    {
        ...
        for(int i=paginaActual*15-15;i<paginaActual*15;i++){
            if(i<datos.size()){
                fila[0]=datos.get(i).getCarnet();
                fila[1]=datos.get(i).getNombre();
                fila[2]=datos.get(i).getApellidos();
                fila[3]=datos.get(i).getTelefono();
                fila[4]=datos.get(i).getCedula();
                fila[5]=datos.get(i).getDireccion().getCiudad();
                fila[6]=datos.get(i).getDireccion().getCalle();
                fila[7]=datos.get(i).getDireccion().getNumero();
                fila[8]=datos.get(i).getEspecialidad();
    ...
    public void leerDatos(){
        ...
        if(archivo.canRead()){
            //recupera los datos del archivo medico y los guarda en la variable
            datos= LeerBinarios.obtenerMedicos(ventana);
        }
