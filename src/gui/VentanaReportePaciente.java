 ...
 * @author Grupo 5
 */
public class VentanaReportePaciente extends javax.swing.JInternalFrame {
   
    private ArrayList <Paciente> datos= new ArrayList<>();
     ...
     */
    public VentanaReportePaciente(java.awt.Frame parent) {
        initComponents();
        ventana=parent;
    ...
    /**
     * carga los datos de los pacientes y los guarda en un arreglo
     */
    ...
    public void leerDatos(){
        ...
        if(archivo.canRead()){
            ...
            datos= LeerBinarios.obtenerPacientes(ventana);
        }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Reporte de pacientes");
